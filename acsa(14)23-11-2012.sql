...
--
-- Host: localhost
-- Generation Time: Nov 23, 2012 at 03:15 PM
...
('9c4b686a990e0f49a2b06ea1b5fcf272', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.64 Safari/537.11', 1353680706, 'a:7:{s:9:"user_data";s:0:"";s:7:"user_id";s:2:"19";s:8:"username";s:6:"perrop";s:10:"empresa_id";s:1:"5";s:6:"status";s:1:"1";s:8:"es_admin";s:1:"0";s:7:"empresa";s:90:"O:7:"Empresa":3:{s:6:"nombre";s:9:"petrolera";s:4:"cuit";s:8:"78976122";s:2:"id";s:1:"5";}";}'),
('9df839b30002c756e62440794a3efda4', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; rv:16.0) Gecko/20100101 Firefox/16.0', 1353683579, 'a:7:{s:9:"user_data";s:0:"";s:7:"user_id";s:1:"1";s:8:"username";s:4:"fran";s:10:"empresa_id";s:1:"1";s:6:"status";s:1:"1";s:8:"es_admin";s:1:"1";s:7:"empresa";s:101:"O:7:"Empresa":3:{s:6:"nombre";s:18:"Argentina Clearing";s:4:"cuit";s:9:"123456789";s:2:"id";s:1:"1";}";}'),
('b6d0d737ff81cc2d33215b40f2f9d9af', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.64 Safari/537.11', 1353682969, '');

-- --------------------------------------------------------

--
-- Table structure for table `cuentas_registro`
--
...
--
-- Dumping data for table `cuentas_registro`
--
...
(5, 'AFC', 121, 5, 2, 1, '0000-00-00 00:00:00'),
(7, 'Financiador 3', 7, 3, 1, 1, '0000-00-00 00:00:00'),
(8, 'Tiu', 1212, 1, 1, 1, '2012-11-22 14:44:27'),
(9, 'dssadasdsa', 1232323, 2, 2, 0, '2012-11-22 14:47:27'),
(10, 'OMG', 121, 5, 2, 1, '2012-11-22 14:48:08');
...
(1, 0, 2, 'Argentina Clearing', '123456789', '2011-06-09', 1),
(2, 0, 2, 'Warrantera 1', '123456', '2011-06-18', 1),
(3, 0, 2, 'Warrantera 2', '1234', '2011-09-13', 1),
(4, 0, 3, 'petrolera_test', '11002233', '2012-02-17', 1),
(5, 0, 3, 'petrolera', '78976122', '2012-02-17', 1),
(6, 0, 2, 'asdasd', '23232', '2012-11-22', 1),
(7, 0, 3, 'Neo', '121211', '2012-11-22', 0),
(8, 0, 2, 'Glo', '212323', '2012-11-22', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ewarrant`
--
...
(9, 'prueba', NULL, 5, 'Un form de prueba', 'Formulario de prueba', 'Crear');
...
(6, 1, 'perrox', 'asd', NULL, NULL, NULL, NULL),
...
--
-- Table structure for table `forms_entradas`
--
...
--
-- Dumping data for table `forms_entradas`
--
...
--
-- Table structure for table `grupos_fields`
--
...
--
-- Dumping data for table `grupos_fields`
--
...
(3, '127.0.0.1', 'asd', '2012-11-23 14:56:32');
...
(39, 'registro_producto', 'seguridad', 'gestionar_productos', 1),
(40, 'modificar_producto', 'seguridad', 'gestionar_productos', 1),
(41, 'eliminar_producto', 'seguridad', 'gestionar_productos', 1),
(42, 'registro_cuenta_registro', 'seguridad', 'gestionar_cuentas_registro', 1),
(43, 'modificar_cuenta_registro', 'seguridad', 'gestionar_cuentas_registro', 1),
(44, 'eliminar_cuenta_registro', 'seguridad', 'gestionar_cuentas_registro', 1),
(45, 'activar_cuenta_registro', 'seguridad', 'gestionar_cuentas_registro', 1),
...
(27, 6, 'asd2', 'body {\r\n    background-color: #ccc;\r\n}', 'html', '2012-05-30 15:05:36', 2, 0),
(30, 5, 'principal', 'alert("SDASADSADASDSAD");', 'js', '2012-11-09 20:45:55', 1, 0),
(31, 5, 'p2', 'alert("{{ url_sitio }}");', 'js', '2012-11-16 19:39:01', 1, 0),
(32, 5, 'p3', 'alert("js3");', 'js', '2012-11-16 19:39:18', 1, 0);
...
--
-- Table structure for table `tipo_cuenta_registro`
--
...
--
-- Dumping data for table `tipo_cuenta_registro`
--
...
(1, 1, 'fran', '$P$BOd3bMRhe5jVnl7auEicOuJ.zyLunF.', 'framini@gmail.com', 1, 1, 0, NULL, NULL, NULL, NULL, NULL, '127.0.0.1', '2012-11-23 13:45:48', '2012-02-08 14:12:21', '2012-11-23 13:45:48', 1),
(2, 3, 'quique', '$P$BWc1sneOmJCOstjNjtxJXxxucacnvU.', 'quiero_newage22@yahoo.com', 57, 1, 0, NULL, NULL, NULL, NULL, NULL, '127.0.0.1', '2012-11-23 13:47:13', '2012-02-16 14:53:20', '2012-11-23 14:13:44', 0),
(11, 2, 'pepito', '$P$Ba77MDq6rBN0ec4zeGpJY6bKdF7TSy1', 'asdasd@d.com', 1, 1, 0, NULL, NULL, NULL, 'asdasdd@d.com', '28d617a7f3b1e3cedbe21c2fa567e1b8', '127.0.0.1', '0000-00-00 00:00:00', '2012-02-08 19:11:34', '2012-02-24 18:58:52', 0);
