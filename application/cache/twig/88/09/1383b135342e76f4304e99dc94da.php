...
/* frr_temp/articulos/index.html */
class __TwigTemplate_88091383b135342e76f4304e99dc94da extends Twig_Template
{
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entrada"]) {
            ...
            if ($this->getAttribute($_entrada_, "articulos_imagen")) {
                ...
                if (isset($context["entrada"])) { $_entrada_ = $context["entrada"]; } else { $_entrada_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_entrada_, "articulos_imagen"), "html", null, true);
            ...
            // line 24
            if (isset($context["entrada"])) { $_entrada_ = $context["entrada"]; } else { $_entrada_ = null; }
            echo twig_escape_filter($this->env, Twig::longitud_max($this->getAttribute($_entrada_, "articulos_contenido"), 140), "html", null, true);
            echo "
                <div class=\"row\">
                    <div class=\"span12\">
...
";
    ...
    {
        return "frr_temp/articulos/index.html";
    }
