		...
		$(function() {
			/*$('.btn-large.btn-primary').on('click', function(event) {
				...
				var campos = {
					...
					relative:   $('input[name="relative"]').val(),
					calculo_denominador:   $('#calculo_denominador').val(),
					relacion_objetivo:   $('input[name="relacion_objetivo"]').val(),
                                ...
                                <?php echo form_open($this->uri->uri_string()); ?>
                                	...
                                	<div class="row">
                                		<div class="span6 control-group">
		                                    ...
		                                    <input class="span4" type="text" name="id" id="id" />
										</div>
									</div>
									...
									<div class="row">
                                		<div class="span6 control-group">
		                                    ...
		                                    <textarea class="span4" name="descripcion" id="descripcion">
		                                    </textarea>
										</div>
									</div>
									...
									<div class="row">
                                		<div class="span6 control-group">
		                                    ...
		                                    <label class="radio" for="relative"><input type="radio" name="relative" value="0" /> No </label>
		                                    <label class="radio" for="relative"><input type="radio" name="relative" value="1" /> Si </label>
										</div>
									</div>
									...
									<div class="row">
                                		<div class="span6 control-group">
		                                    ...
		                                    <textarea class="span4" name="calculo_nominador" id="calculo_nominador"></textarea>
										</div>
									</div>
									...
									<div class="row">
                                		<div class="span6 control-group">
		                                    ...
		                                    <textarea class="span4" name="calculo_denominador" id="calculo_denominador"></textarea>
										</div>
									</div>
									...
									<div class="row">
                                		<div class="span6 control-group">
		                                    ...
		                                    <label class="radio" for="relacion_objetivo"><input type="radio" name="relacion_objetivo" value="0" /> No </label>
		                                    <label class="radio" for="relacion_objetivo"><input type="radio" name="relacion_objetivo" value="1" /> Si </label>
										</div>
									</div>
									...
									<div class="row">
                                		<div class="span6 control-group">
		                                    ...
		                                    <textarea class="span4" name="drilldown" id="drilldown"></textarea>
										</div>
									</div>
